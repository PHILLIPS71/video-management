...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Giantnodes.Service.Orchestrator.Domain.Aggregates.Encodes.Encode", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("RecipeId")
                        .HasDatabaseName("ix_encodes_recipe_id");

                    b.ToTable("encodes", "orchestrator");
                });

            modelBuilder.Entity("Giantnodes.Service.Orchestrator.Domain.Aggregates.Encodes.Entities.EncodeSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("encode_snapshots", "orchestrator");
                });

            modelBuilder.Entity("Giantnodes.Service.Orchestrator.Domain.Aggregates.Entries.FileSystemEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Giantnodes.Service.Orchestrator.Domain.Aggregates.Libraries.Library", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("libraries", "orchestrator");
                });

            modelBuilder.Entity("Giantnodes.Service.Orchestrator.Domain.Aggregates.Recipes.Recipe", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<bool>("UseHardwareAcceleration")
                        .HasColumnType("boolean")
                        .HasColumnName("use_hardware_acceleration");
                    ...
                    b.ToTable("recipes", "orchestrator");
                });

            modelBuilder.Entity("Giantnodes.Service.Orchestrator.Persistence.Sagas.EncodeSagaState", b =>
                {
                    ...
                    b.HasIndex("InputFilePath")
                        .IsUnique()
                        .HasDatabaseName("ix_encode_saga_state_input_file_path");

                    b.HasIndex("OutputFilePath")
                        .IsUnique()
                        .HasDatabaseName("ix_encode_saga_state_output_file_path");

                    b.ToTable("encode_saga_state", "orchestrator");
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.InboxState", b =>
                {
                    ...
                    b.ToTable("inbox_state", "orchestrator");
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxMessage", b =>
                {
                    ...
                    b.ToTable("outbox_message", "orchestrator");
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxState", b =>
                {
                    ...
                    b.ToTable("outbox_state", "orchestrator");
                });

            modelBuilder.Entity("Giantnodes.Service.Orchestrator.Domain.Aggregates.Entries.Directories.FileSystemDirectory", b =>
                {
                    b.HasBaseType("Giantnodes.Service.Orchestrator.Domain.Aggregates.Entries.FileSystemEntry");

                    b.ToTable("file_system_directories", "orchestrator");
                });

            modelBuilder.Entity("Giantnodes.Service.Orchestrator.Domain.Aggregates.Entries.Files.FileSystemFile", b =>
                {
                    b.HasBaseType("Giantnodes.Service.Orchestrator.Domain.Aggregates.Entries.FileSystemEntry");
                    ...
                    b.ToTable("file_system_files", "orchestrator");
                });

            modelBuilder.Entity("Giantnodes.Service.Orchestrator.Domain.Aggregates.Encodes.Encode", b =>
                {
                    b.HasOne("Giantnodes.Service.Orchestrator.Domain.Aggregates.Entries.Files.FileSystemFile", "File")
                        .WithMany("Encodes")
                    ...
                    b.HasOne("Giantnodes.Service.Orchestrator.Domain.Aggregates.Recipes.Recipe", "Recipe")
                        .WithMany("Encodes")
                        .HasForeignKey("RecipeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_encodes_recipes_recipe_id");

                    b.OwnsOne("Giantnodes.Service.Orchestrator.Domain.Aggregates.Encodes.Values.EncodeSpeed", "Speed", b1 =>
                        {
                            ...
                            b1.ToTable("encodes", "orchestrator");
                    ...
                    b.OwnsOne("Giantnodes.Service.Orchestrator.Domain.Values.Machine", "Machine", b1 =>
                        {
                            b1.Property<Guid>("EncodeId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.Property<string>("UserName")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("machine_user_name");
            ...
            modelBuilder.Entity("Giantnodes.Service.Orchestrator.Domain.Aggregates.Encodes.Entities.EncodeSnapshot", b =>
                {
                    b.HasOne("Giantnodes.Service.Orchestrator.Domain.Aggregates.Encodes.Encode", "Encode")
                        .WithMany("Snapshots")
                        .HasForeignKey("EncodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.OwnsMany("Giantnodes.Service.Orchestrator.Domain.Values.AudioStream", "AudioStreams", b1 =>
                        {
                            ...
                            b1.ToTable("encode_snapshots_audio_streams", "orchestrator");
                    ...
                    b.OwnsMany("Giantnodes.Service.Orchestrator.Domain.Values.SubtitleStream", "SubtitleStreams", b1 =>
                        {
                            b1.Property<Guid>("EncodeSnapshotId")
                                .HasColumnType("uuid")
                                .HasColumnName("encode_snapshot_id");
                            ...
                            b1.ToTable("encode_snapshots_subtitle_streams", "orchestrator");
                    ...
                    b.OwnsMany("Giantnodes.Service.Orchestrator.Domain.Values.VideoStream", "VideoStreams", b1 =>
                        {
                            b1.Property<Guid>("EncodeSnapshotId")
                                .HasColumnType("uuid")
                                .HasColumnName("encode_snapshot_id");
                            ...
                            b1.ToTable("encode_snapshots_video_streams", "orchestrator");

                            b1.WithOwner()
                                .HasForeignKey("EncodeSnapshotId")
                                .HasConstraintName("fk_encode_snapshots_video_streams_encode_snapshots_encode_snap");

                            b1.OwnsOne("Giantnodes.Service.Orchestrator.Domain.Aggregates.Entries.Files.Values.VideoQuality", "Quality", b2 =>
                                {
                                    ...
                                    b2.ToTable("encode_snapshots_video_streams", "orchestrator");
            ...
            modelBuilder.Entity("Giantnodes.Service.Orchestrator.Domain.Aggregates.Entries.FileSystemEntry", b =>
                {
                    b.HasOne("Giantnodes.Service.Orchestrator.Domain.Aggregates.Libraries.Library", "Library")
                        .WithMany("Entries")
                        .HasForeignKey("LibraryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Giantnodes.Service.Orchestrator.Domain.Aggregates.Entries.Directories.FileSystemDirectory", "ParentDirectory")
                        .WithMany("Entries")
            ...
            modelBuilder.Entity("Giantnodes.Service.Orchestrator.Domain.Aggregates.Libraries.Library", b =>
                {
                    b.OwnsOne("Giantnodes.Service.Orchestrator.Domain.Values.PathInfo", "PathInfo", b1 =>
                        {
                            ...
                            b1.ToTable("libraries", "orchestrator");
                    ...
                    b.OwnsMany("Giantnodes.Service.Orchestrator.Domain.Values.AudioStream", "AudioStreams", b1 =>
                        {
                            ...
                            b1.ToTable("file_system_files_audio_streams", "orchestrator");
                    ...
                    b.OwnsMany("Giantnodes.Service.Orchestrator.Domain.Values.SubtitleStream", "SubtitleStreams", b1 =>
                        {
                            ...
                            b1.ToTable("file_system_files_subtitle_streams", "orchestrator");
                    ...
                    b.OwnsMany("Giantnodes.Service.Orchestrator.Domain.Values.VideoStream", "VideoStreams", b1 =>
                        {
                            ...
                            b1.ToTable("file_system_files_video_streams", "orchestrator");
                            ...
                            b1.OwnsOne("Giantnodes.Service.Orchestrator.Domain.Aggregates.Entries.Files.Values.VideoQuality", "Quality", b2 =>
                                {
                                    ...
                                    b2.ToTable("file_system_files_video_streams", "orchestrator");
