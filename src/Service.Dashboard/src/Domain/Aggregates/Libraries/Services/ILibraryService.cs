...
{
    /// <summary>
    /// Retrieves a read-only collection of <see cref="IFileSystemInfo" /> objects that represent the files and
    /// subdirectories inside the specified library.
    /// </summary>
    /// <param name="library">A library specifying the path on which to search the file system.</param>
