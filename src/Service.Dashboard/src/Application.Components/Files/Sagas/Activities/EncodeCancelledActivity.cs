...
public class EncodeCancelledActivity : IStateMachineActivity<EncodeSagaState>
{
    private readonly IUnitOfWorkService _uow;
    private readonly IFileSystemFileRepository _repository;

    public EncodeCancelledActivity(
    ...
    {
        context.CreateScope(KebabCaseEndpointNameFormatter.Instance.Message<EncodeCancelledActivity>());
    }
