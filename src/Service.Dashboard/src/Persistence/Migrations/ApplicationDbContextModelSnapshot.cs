...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Giantnodes.Service.Dashboard.Domain.Aggregates.Recipes.Recipe", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Giantnodes.Service.Dashboard.Domain.Aggregates.Encodes.Encode", b =>
                {
                    ...
                    b.HasOne("Giantnodes.Service.Dashboard.Domain.Aggregates.Recipes.Recipe", "Recipe")
                        .WithMany("Encodes")
                    ...
                    b.OwnsOne("Giantnodes.Service.Dashboard.Domain.Values.Machine", "Machine", b1 =>
                        {
                            b1.Property<Guid>("EncodeId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
