    ...
    public partial class v001 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_file_system_directory", x => x.id);
                    table.ForeignKey(
                        name: "fk_file_system_entries_file_system_entries_parent_directory_id",
                        column: x => x.parent_directory_id,
                        principalSchema: "dashboard",
                        principalTable: "file_system_directory",
                        principalColumn: "id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_file_system_file", x => x.id);
                    table.ForeignKey(
                        name: "fk_file_system_entries_file_system_entries_parent_directory_id",
                        column: x => x.parent_directory_id,
                        principalSchema: "dashboard",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_audio_streams_file_system_file_file_system_file_id",
                        column: x => x.file_system_file_id,
                        principalSchema: "dashboard",
                        principalTable: "file_system_file",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_encodes_file_system_entries_file_id",
                        column: x => x.file_id,
                        principalSchema: "dashboard",
                        principalTable: "file_system_file",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_subtitle_streams_file_system_file_file_system_file_id",
                        column: x => x.file_system_file_id,
                        principalSchema: "dashboard",
                        principalTable: "file_system_file",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_video_streams_file_system_file_file_system_file_id",
                        column: x => x.file_system_file_id,
                        principalSchema: "dashboard",
                        principalTable: "file_system_file",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_file_system_directory_library_id",
                schema: "dashboard",
                table: "file_system_directory",
                column: "library_id");

            migrationBuilder.CreateIndex(
                name: "IX_file_system_directory_parent_directory_id",
                schema: "dashboard",
                table: "file_system_directory",
                column: "parent_directory_id");

            migrationBuilder.CreateIndex(
                name: "IX_file_system_file_library_id",
                schema: "dashboard",
                table: "file_system_file",
                column: "library_id");
